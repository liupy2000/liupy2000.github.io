...
- *2016–2020*, B.Eng. in Precision Instrument, Tsinghua University, Beijing, China.
...
- Our paper “Spatial in-profile monitoring via latent tensor Gaussian process with mixed effects” was published in *Technometrics*.
- Our paper “Design and analysis for digital twin optimization” was published in *Quality and Reliability Engineering International*.
- Our review on functional data analysis in industrial intelligent systems was published in *Journal of Intelligent Manufacturing*.
- Our paper on product design changes and resilient supply chains was published in *International Journal of Production Economics*.
...
- Our paper “Stream of variation modeling and monitoring for heterogeneous profiles in multi-stage manufacturing processes” was published in *IISE Transactions*.
...
- Received the **Apple Scholars in AI/ML PhD Fellowship Nomination Award**.
- Our paper “Heterogeneous multivariate functional time series modeling: A state space approach” was published in *IEEE Transactions on Knowledge and Data Engineering*.
- Our survey “A comprehensive survey of recent research on profile data analysis” was published in *Journal of Quality Technology*.

## 2023

- *2023.12* — Named a **Best Student Paper Award Finalist** at the China Industrial Engineering PhD Forum.
- *2023.10* — Received the **Third Prize** at the First National Mathematics and Statistics PhD Forum.
- *2023.09* — Received the **NSK Sino-Japan Friendship Outstanding Paper Prize**.
- *2023.07* — Received the **Third Prize** at the 11th Workshop on Quality and Reliability Science & Technology.
...
- *2020.11* — Received the **Best Oral Presentation Award** at the China Industrial Engineering PhD Forum.
...
**Email:** [liupy25@nus.edu.sg](mailto:liupy25@nus.edu.sg)

**Address:** E1, National University of Singapore, Singapore
